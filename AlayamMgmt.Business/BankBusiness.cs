...
{
    public class BankBusiness : BaseBusiness<BankDBEntity>, IBankBusiness
    {
        public BankBusiness(string aduitUser)
            : base(aduitUser)
        { }


        public List<BankDBEntity> GetOrgId(int OrgId, bool? active)
        {
            if(active == null)
