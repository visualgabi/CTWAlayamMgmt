...
{
    public class EventTypeBusiness : BaseBusiness<EventTypeDBEntity>, IEventTypeBusiness
    {
        public EventTypeBusiness(string aduitUser)
            : base(aduitUser)
        { }


        public List<EventTypeDBEntity> GetOrgId(int OrgId, bool? active)
        {
            if(active == null)
