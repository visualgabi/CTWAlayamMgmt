    ...
    public class FamilyController : BaseApiController
    {
        ...
        public HttpResponseMessage Get(bool? active)
        {
            ...
            try
            {
                ...
                List<FamilyModel> familyModels = GetFamilyModels(familyBusiness.Get(active));
        ...
        public HttpResponseMessage GetFamiliesByOrgId(int orgId, bool? active)
        {
            ...
            try
            {
                ...
                List<FamilyModel> familyModels = GetFamilyModels(familyBusiness.GetFamiliesByOrgId(orgId, active));
        ...
        public HttpResponseMessage GetRecentMembersByOrgId(int orgId)
        {
            ...
            try
            {
                ...
                IFamilyBusiness familyBusiness = new FamilyBusiness(claimModel.LoginUserEmail);
                List<FamilyModel> familyModels = GetFamilyModels(familyBusiness.GetRecentMembersByOrgId(orgId));
        ...
        public HttpResponseMessage GetMembers(int orgId, DateTime? membershipBeginDate, DateTime? membershipEndDate)
        {
            ...
            try
            {
                ...
                IFamilyBusiness familyBusiness = new FamilyBusiness(claimModel.LoginUserEmail);
                List<FamilyModel> familyModels = GetFamilyModels(familyBusiness.GetMembers(orgId, membershipBeginDate, membershipEndDate));
        ...
        public HttpResponseMessage GetVisitors(int orgId, DateTime? visitorBeginDate, DateTime? visitorEndDate)
        {
            ...
            try
            {
                ...
                IFamilyBusiness familyBusiness = new FamilyBusiness(claimModel.LoginUserEmail);
                List<FamilyModel> familyModels = GetFamilyModels(familyBusiness.GetVisitors(orgId, visitorBeginDate, visitorEndDate));
        ...
        public HttpResponseMessage GetRecentVisitorsByOrgId(int orgId)
        {
            ...
            try
            {
                ...
                IFamilyBusiness familyBusiness = new FamilyBusiness(claimModel.LoginUserEmail);
                List<FamilyModel> familyModels = GetFamilyModels(familyBusiness.GetRecentVisitorsByOrgId(orgId));
        ...
        public HttpResponseMessage GetById(int id)
        {
            ...
            try
            {
                ...
                IBusiness<FamilyDBEntity> familyBusiness = new BaseBusiness<FamilyDBEntity>(claimModel.LoginUserEmail);
                FamilyModel familyModel = GetFamilyModel(familyBusiness.GetById(id));
        ...
        private List<FamilyModel> GetFamilyModels(List<FamilyDBEntity> familyDBEntities)
        {
            List<FamilyModel> familyModels = new List<FamilyModel>();

            foreach (FamilyDBEntity x in familyDBEntities)
            {
                familyModels.Add(GetFamilyModel(x));
            };
        ...
        private FamilyModel GetFamilyModel(FamilyDBEntity familyDBEntity)
        {
            return new FamilyModel()
            {
                ...
                FamilyMembers = GetFamilyMemberModels(familyDBEntity.FamilyMembers),
