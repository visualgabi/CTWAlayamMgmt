...
{
     [RoutePrefix("api/OfferingType")]
    public class OfferingTypeController : BaseApiController
    {
         ...
         public HttpResponseMessage Get(bool? active)
         {
             ...
             {                
                 ...
                 List<OrganizationLookupModel> offeringTypeBusinessModels = GetOrganizationLookModels<OfferingTypeDBEntity>(offeringTypeBusiness.Get(active));

                 response = Request.CreateResponse(HttpStatusCode.OK, offeringTypeBusinessModels);
                 return response;
             }
             catch (Exception ex)
             {
         ...
         public HttpResponseMessage GetByOrgId(int OrgId, bool? active)
         {
             ...
             {
                 IOfferingTypeBusiness offeringTypeBusiness = new OfferingTypeBusiness(Constant.DEFAULT_EMAIL);
                 List<OrganizationLookupModel> offeringTypeBusinessModels = GetOrganizationLookModels<OfferingTypeDBEntity>(offeringTypeBusiness.GetOrgId(OrgId, active));
         ...
         public HttpResponseMessage Enable([FromBody] EnableModel enableModel)
         {
             ...
             {
                 IOfferingTypeBusiness offeringTypeBusiness = new OfferingTypeBusiness(Constant.DEFAULT_EMAIL);
                 byte[] returnValue = offeringTypeBusiness.Enable(enableModel.Id, enableModel.Active);
         ...
         public HttpResponseMessage Save(OrganizationLookupModel model)
         {
             ...
             {
                 IOfferingTypeBusiness offeringTypeBusiness = new OfferingTypeBusiness(Constant.DEFAULT_EMAIL);
                 offeringTypeBusiness.Save(GetOfferingTypeDBEntity(model));
         ...
         protected OfferingTypeDBEntity GetOfferingTypeDBEntity(OrganizationLookupModel model)
         {
             return new OfferingTypeDBEntity()
             {
                 Active = model.Active,
