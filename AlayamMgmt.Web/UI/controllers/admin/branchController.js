'use strict';
app.controller('branchController', ['$scope', 'lookupService', 'organizationService', 'sharedService', 'authService', '$location','$routeParams',
    function ($scope, lookupService, organizationService, sharedService, authService, location, $routeParams) {
