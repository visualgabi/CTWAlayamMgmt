...
app.controller('orglstController', ['$scope', 'organizationService', 'ngTableParams', '$filter', 'sharedService',
        ...
        organizationService.getOrganizations(null).then(function (results) {         
            ...
            $scope.tableParams = new ngTableParams({
                ...
                getData: function ($defer, params) {
                    ...
                    var filteredData = $filter('filter')($scope.orgs, $scope.filterText);
