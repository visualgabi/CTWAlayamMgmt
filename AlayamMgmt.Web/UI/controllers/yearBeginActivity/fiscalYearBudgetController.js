'use strict';
app.controller('fiscalYearBudgetController', ['$scope', 'lookupService', 'fiscalYearBudgetService', '$filter', 'sharedService', 'authService', 'ngTableParams', 'orgFiscalYearService',
   ...
   // $scope.fundTypes = [];
        ...
        fiscalYearBudgetService.getFiscalYearBudgetByOrgId($scope.authentication.orgId, null).then(function (results) {
            ...
            $scope.tableParams = new ngTableParams({
                ...
                getData: function ($defer, params) {
                    ...
                    var filteredData = $filter('filter')($scope.fiscalYearBudgets, $scope.filterText);
    ...
    $scope.initialize = function (id) {
        ...
        if (id != 0) {
            var results = $filter('filter')($scope.fiscalYearBudgets, { id: id });
    ...
    $scope.enableFiscalYearBudget = function (id, status) {
        ...
        var orgFiscalYearBudget = $filter('filter')($scope.fiscalYearBudgets, { id: id });
