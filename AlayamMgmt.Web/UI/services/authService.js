                ...
                localStorageService.set('authorizationData',
                   {
                       ...
                       orgId: response.orgId, clientId: response["as:client_id"], rememberMe: loginData.rememberMe, orgName: response.orgName, userId: response.userId, currency: response.currency, appVersion: response.appVersion
                   });
