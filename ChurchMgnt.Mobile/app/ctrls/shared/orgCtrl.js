'use strict';
app.controller('orgCtrl', ['$scope', 'lookupService', 'organizationService', '$stateParams', 'sharedService', 'authService', '$location','$state',
    function ($scope, lookupService, organizationService, $stateParams, sharedService, authService, location, $state) {
    ...
    $scope.close = function () {
        if ($scope.authentication.role == 1)
            ...
            $state.go('orgDtls',{'id':$scope.orgData.id});
    ...
    $scope.saveOrg = function (orgForm) {
        ...
        if (orgForm.$valid) {
            ...
            organizationService.saveOrganization($scope.orgData).then(function (results) {               
                ...
                $scope.alertMsg = sharedService.getSaveSuccessMsg("Org");
                $scope.showAlert = true;              
