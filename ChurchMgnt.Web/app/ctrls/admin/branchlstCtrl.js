...
app.controller('branchlstCtrl', ['$scope', 'organizationService', 'ngTableParams', '$filter', 'sharedService', 'authService',
        ...
        organizationService.getBranchesByOrgId($scope.authentication.orgId, null).then(function (results) {
            ...
            $scope.tableParams = new ngTableParams({
                ...
                getData: function ($defer, params) {
                    ...
                    $scope.filteredData = $filter('filter')($scope.branches, $scope.filterText);
    ...
    $scope.enableBranch = function (id, status) {
        ...
        var org = $filter('filter')($scope.branches, { id: id }, true);
