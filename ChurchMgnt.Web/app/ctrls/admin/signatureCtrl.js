'use strict';
app.controller('signatureCtrl', ['$scope', '$filter', 'sharedService', 'authService', 'ngTableParams', 'lookupService', 'FileUploader', '$window', 'localStorageService', 'Lightbox', 'ngAuthSettings', 'imageUploadService',
function ($scope, $filter, sharedService, authService, ngTableParams, lookupService, FileUploader, $window, localStorageService, Lightbox, ngAuthSettings, imageUploadService) {
    ...
    var uploader = $scope.uploader = new FileUploader({
        url: serviceBase + 'api/signature/post'
    });
    ...
    uploader.onSuccessItem = function (fileItem, response, status, headers) {
        ...
        $scope.formLoad();
        showMsg('Pastor signature has been uploaded successfully. Please refresh page to reflect in the below image gallery', 1);
        //// clear();
