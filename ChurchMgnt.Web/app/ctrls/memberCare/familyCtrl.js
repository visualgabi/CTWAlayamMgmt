'use strict';
app.controller('familyCtrl', ['$scope', 'lookupService', 'familyService', '$stateParams', '$filter', 'sharedService', 'authService', 'organizationService', 'notificationService', '$location','$state',
function ($scope, lookupService, familyService, $stateParams, $filter, sharedService, authService, organizationService, notificationService, $location,$state) {
