'use strict';
app.controller('familyOfferingRptCtrl', ['$scope', 'lookupService', '$filter', 'sharedService', 'authService', '$window', 'familyService','offeringService','familyMemberService','sponsorService',
    function ($scope, lookupService, $filter, sharedService, authService, $window, familyService, offeringService, familyMemberService, sponsorService) {
