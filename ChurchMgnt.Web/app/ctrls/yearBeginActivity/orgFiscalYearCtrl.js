'use strict';
app.controller('orgFiscalYearCtrl', ['$scope', 'lookupService', 'orgFiscalYearService', '$filter', 'sharedService', 'authService', 'ngTableParams',
   ...
   // $scope.FiscalYears = [];
        ...
        orgFiscalYearService.getOrgFiscalYearsByOrgId($scope.authentication.orgId, null).then(function (results) {
            ...
            $scope.tableParams = new ngTableParams({
                ...
                getData: function ($defer, params) {
                    ...
                    $scope.filteredData = $filter('filter')($scope.orgFiscalYears, $scope.filterText);
    ...
    $scope.initialize = function (id) {
        ...
        if (id != 0) {           
                var results = $filter('filter')($scope.orgFiscalYears, { id: id },true);
    ...
    $scope.enableOrgFiscalYear = function (id, status) {
        ...
        var organizationfiscalYear = $filter('filter')($scope.orgFiscalYears, { id: id },true);
