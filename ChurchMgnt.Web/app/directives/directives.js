...
angular
    ...
    .directive('uiSelectRequired', ngFiles)
    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                // Default title
                var title = 'ChurchMgnt';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'ChurchMgnt | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
function panelTools($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl: 'app/views/layout/panel_tools.html',
        controller: function ($scope, $element) {
...
function panelToolsFullscreen($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl: 'app/views/layout/panel_tools_fullscreen.html',
        controller: function ($scope, $element) {
            // Function for collapse ibox
            $scope.showhide = function () {
                var hpanel = $element.closest('div.hpanel');
