            ...
            inFlightAuthRequest.success(function (response) {
                ...
                if (authData.rememberMe) {
                    ...
                    localStorageService.set('authorizationData',
                     {
                         ...
                         orgId: response.orgId, rememberMe: true, orgName: response.orgName, userId: response.userId, currency: response.currency, appVersion: response.appVersion,
                         lastTaxFiledFiscalEndDate: response.lastTaxFiledFiscalEndDate, birthdayAvailable: response.birthdayAvailable
                     });
                    ...
                    $window.sessionStorage.setItem('authorizationData', JSON.stringify({
                        token: response.access_token, userName: response.userName, refreshToken: response.refresh_token, useRefreshTokens: true, role: response.role,
                        orgId: response.orgId, rememberMe: false, orgName: response.orgName, userId: response.userId, currency: response.currency, appVersion: response.appVersion
                        , lastTaxFiledFiscalEndDate: response.lastTaxFiledFiscalEndDate, birthdayAvailable: response.birthdayAvailable
                    }));
