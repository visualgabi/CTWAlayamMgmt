...
app.factory('familyService', ['$http', '$q', 'ngAuthSettings', function ($http, $q, ngAuthSettings) {
    ...
    var _getFamiliesIncludeMembersByOrgId = function (orgId, active) {
        return $http.get(serviceBase + 'api/family/GetFamiliesIncludeMembersByOrgId?orgId=' + orgId + '&active=' + active).then(function (results) {
            return results;
        });
    };

    var _getFamiliesIncludeMembersAndGroupByOrgId = function (orgId, active) {
        return $http.get(serviceBase + 'api/family/GetFamiliesIncludeMembersAndGroupByOrgId?orgId=' + orgId + '&active=' + active).then(function (results) {
            return results;
        });
    };
    ...
    familyServiceFactory.getFamiliesIncludeMembersByOrgId = _getFamiliesIncludeMembersByOrgId;
    familyServiceFactory.getFamiliesIncludeMembersAndGroupByOrgId = _getFamiliesIncludeMembersAndGroupByOrgId;
