...
app.factory('organizationService', ['$http', '$q', 'ngAuthSettings', function ($http, $q, ngAuthSettings) {
    ...
    var _getContributionMsgByOrgId = function (orgId) {
        return $http.get(serviceBase + 'api/Message/GetContributionMessageByOrgId?orgId=' + orgId).then(function (results) {
            return results;
        });
    };
    ...
    ordersServiceFactory.getContributionMsgByOrgId = _getContributionMsgByOrgId;
