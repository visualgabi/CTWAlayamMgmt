...
app.factory('userService', ['$http', '$q', 'ngAuthSettings', 'authService', function ($http, $q, ngAuthSettings, authService) {
    ...
    var _getPastorInfoByOrgId = function (orgId) {

        return $http.get(serviceBase + 'api/user/GetPastorInfoByOrgId?orgId=' + orgId).then(function (results) {
            return results;
        });
    ...
    userFactory.getPastorInfoByOrgId = _getPastorInfoByOrgId;
