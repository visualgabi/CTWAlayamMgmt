...
namespace ChurchMgnt.WebAPI.Controllers
{
    ...
    public class OfferingController : BaseApiController
    {
        ...
        //[CustomAuthorizeAttribute]
        [Route("GetByOrgIdWithPaging")]
        [HttpGet]
        public HttpResponseMessage GetByOrgIdWithPaging(int orgId, bool? active, int page, int pageSize)
        {
            HttpResponseMessage response;
            try
            {
                ...
                //IOfferingBusiness orgOfferingBusiness = new OfferingBusiness(claimModel.LoginUserEmail);
                IOfferingBusiness orgOfferingBusiness = new OfferingBusiness(Constant.DEFAULT_EMAIL);
                List<OrgOfferingModel> orgProfileModels = DBEntityToModel.GetOrgOfferingModels(orgOfferingBusiness.GetByOrgIdWithPaging(orgId, active, page, pageSize));
        ...
        public HttpResponseMessage GetById(int Id)
        {
            ...
            try
            {
                ...
                IOfferingBusiness orgOfferingBusiness = new OfferingBusiness(claimModel.LoginUserEmail);
                OrgOfferingModel orgProfileModel = DBEntityToModel.GetOrgOfferingModel(orgOfferingBusiness.GetById(Id));

                response = Request.CreateResponse(HttpStatusCode.OK, orgProfileModel);
                return response;
